    ...
    <article className="max-w-2xl mx-auto">
      <header className="text-center mb-6 md:mb-10">
        ...
        {chapter.opening_quote && (
          <blockquote className="font-body italic text-text-secondary text-base md:text-lg border-l-2 border-accent-primary/30 pl-3 md:pl-4 mx-auto max-w-md text-left">
            {chapter.opening_quote}
          </blockquote>
        )}
      </header>
      ...
      <div className="prose-reading space-y-4 md:space-y-6">
      ...
      <footer className="mt-8 md:mt-16 pt-6 md:pt-8 border-t border-ink-border">
        {chapter.soundtrack_suggestion && (
          <div className="flex items-center gap-2 md:gap-3 p-3 md:p-4 rounded-lg bg-ink-surface border border-ink-border mb-4 md:mb-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          {chapter.mood && (
            <span className="px-2 py-0.5 md:px-3 md:py-1 rounded-full bg-ink-surface border border-ink-border text-xs md:text-sm text-text-secondary">
              {chapter.mood}
            </span>
          )}
