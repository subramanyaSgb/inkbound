        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={`
                relative flex items-center rounded-lg py-2.5 text-sm font-ui transition-all duration-300
                ${collapsed ? 'justify-center px-0' : 'gap-3 px-3'}
                ${isActive
                  ? 'text-accent-primary bg-accent-primary/[0.08] border-l-[3px] border-l-accent-primary border-y border-r border-y-accent-primary/15 border-r-accent-primary/15 shadow-glow-sm'
                  : 'text-text-muted hover:text-text-primary hover:bg-ink-card/40 border-l-[3px] border-l-transparent border-y border-r border-y-transparent border-r-transparent'
                }
              `}
